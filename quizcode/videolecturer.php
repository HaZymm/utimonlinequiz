	...
	<div id="main">
		<div class="w3-teal-custom">
            ...
            <form method="post" action="insertvideo.php">
                <button id="addbutton">➕ADD VIDEO</button>
            </form>
                <table id="customers">
                    <tr>
                        <td>Video Name</td>
                    ...
                    ?>
                        <tr>
                            ...
                            <form method="post" action="insertvideo.php">
                                <td><button class = "button" name="delete" value="<?php echo $row["videoCode"]; ?>">DELETE</button></td>
                            </form>
                        </tr>
                    <?php
                    }
                    ...
                    ?>
                        <tr>
                            ...
                            <form method="post" action="insertvideo.php">
                                <td><button class = "button" name="delete" value="<?php echo $row1["videoCode"]; ?>">
                                    DELETE
                            </button>
                            </td>
                        </tr>
