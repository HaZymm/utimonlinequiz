<?php
    ...
    if(isset($_POST['buttonback'])){
        echo "<script>window.location='menulecturer.php'</script>";
    }
?>
...
<link rel="stylesheet" type="text/css" href="profilemenulecturer.css">
...
<form action="profilemenulecturer.php" method="post">
    <div class="container">
                        ...
                        <div class="row gutters">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <label class="form-control" id="fullName"><?php echo $row['staffID'] ?></label>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    <label for="eMail">Name</label>
                                    <label class="form-control" id="fullName"><?php echo $row['lecturerName'] ?></label>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    <label for="phone">Email</label>
                                    <label class="form-control" id="fullName"><?php echo $row['lecturerEmail'] ?></label>
                                </div>
                            </div>
                        </div>
                        <div class="row gutters">
